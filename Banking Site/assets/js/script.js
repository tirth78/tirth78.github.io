...
function sendMoney() {
  ...
  if (enterAmount > 8000) {
    alert("Transaction cancelled due to Insufficient Balance");
  } else {
    ...
    alert(`Successful Transaction !!  
      ₹${enterAmount} is sent to ${enterName}@commonwealthbank.com.`);

    // transaction history
    var createPTag = document.createElement("li");
    var textNode = document.createTextNode(
      `₹${enterAmount} is sent to recepient with Email-id ${enterName}@coomonwealthbank.com on ${Date()}.`
    );
